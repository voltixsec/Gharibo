...
> Kaggle T4 worker. It amends the validator's obsolete "TRAINING HAS NOT STARTED" invariant and
> authorises additive v1.4.0 amendments to `docs/MODEL_REGISTRY.md` and
> `docs/TRAINING_STRATEGY.md`. The only change to this frozen baseline is the machine-checked
> `adrs` fact in §2.7 (19 → 20); nothing else in the frozen baseline changed.

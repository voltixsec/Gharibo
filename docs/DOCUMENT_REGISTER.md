...
| Environment Qualification Contract | `docs/ENV_QUALIFICATION_CONTRACT.md` | Architecture | Domain spec | Draft | 1.1.0 | 2026-09-14 |
| Data Factory | `docs/DATA_FACTORY.md` | Architecture | Domain spec | Frozen | 1.2.0 | 2026-09-14 |
...
| Document Register | `docs/DOCUMENT_REGISTER.md` | Architecture | Governance | Living | 1.1.0 | 2026-09-14 |

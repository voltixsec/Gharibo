...
export function renderMasterStateMarkdown(state) {
  ...
  push(
    ...kv([
      ...
      ['Launch attempts recorded', tr.kaggleLaunchAuthorization?.launchAttemptHistory?.length ?? 0],
      ['Launch attempt 1 external status',
        tr.kaggleLaunchAuthorization?.launchAttemptHistory?.[0]?.externalStatus ?? null],
      ['Launch attempt 1 root cause',
        tr.kaggleLaunchAuthorization?.launchAttemptHistory?.[0]?.rootCauseClass ?? null],

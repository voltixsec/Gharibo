...
export function renderMasterStateMarkdown(state) {
  ...
  push(
    ...kv([
      ...
      ['Issuance receipt execution authorized', tr.issuance?.executionAuthorized ?? false],
      ['Execution authorization status', tr.executionAuthorization?.status ?? 'NOT_AUTHORIZED'],
      ['Execution authorization decision', tr.executionAuthorization?.decisionId ?? null],
      ['Execution authorization hash', tr.executionAuthorization?.authorizationHash ?? null],
      ['Execution authorized', tr.executionAuthorization?.executionAuthorized ?? false],
      ['Kaggle start authorized', tr.executionAuthorization?.kaggleStartAuthorized ?? false],
      ['Execution started', tr.executionAuthorization?.executionStarted ?? false],
      ['Kaggle start authorization', tr.kaggleStartAuthorization?.status ?? 'NOT_AUTHORIZED'],
      ['Kaggle start decision', tr.kaggleStartAuthorization?.decisionId ?? null],
      ['Kaggle start authorization hash', tr.kaggleStartAuthorization?.startAuthorizationHash ?? null],
      ['Launch bundle hash', tr.kaggleStartAuthorization?.launchBundleHash ?? null],
      ['Launch notebook hash', tr.kaggleStartAuthorization?.notebookSha256 ?? null],
      ['Kaggle start authorized', tr.kaggleStartAuthorization?.startAuthorized ?? false],
      ['Launch attempted', tr.kaggleStartAuthorization?.launchAttempted ?? false],
      ['Kaggle launch repair status', tr.kaggleLaunchAuthorization?.status ?? 'NOT_AUTHORIZED'],
      ['Kaggle launch repair decision', tr.kaggleLaunchAuthorization?.decisionId ?? null],
      ['Kaggle launch repair authorization hash', tr.kaggleLaunchAuthorization?.launchAuthorizationHash ?? null],
      ['Repaired launch bundle hash', tr.kaggleLaunchAuthorization?.launchBundleHash ?? null],
      ['Repaired launch notebook hash', tr.kaggleLaunchAuthorization?.notebookSha256 ?? null],
      ['Superseded launch bundle hash', tr.kaggleLaunchAuthorization?.supersededLaunchBundleHash ?? null],
      ['Superseded launch notebook hash', tr.kaggleLaunchAuthorization?.supersededNotebookSha256 ?? null],
      ['Kaggle launch reauthorization status',
        tr.kaggleLaunchReauthorization?.status ?? 'NOT_AUTHORIZED'],
      ['Kaggle launch reauthorization decision',
        tr.kaggleLaunchReauthorization?.decisionId ?? null],
      ['Kaggle launch reauthorization hash',
        tr.kaggleLaunchReauthorization?.launchAuthorizationHash ?? null],
      ['Reauthorized launch bundle hash',
        tr.kaggleLaunchReauthorization?.launchBundleHash ?? null],
      ['Reauthorized launch notebook hash',
        tr.kaggleLaunchReauthorization?.notebookSha256 ?? null],
      ['Reauthorization superseded bundle hash',
        tr.kaggleLaunchReauthorization?.supersededLaunchBundleHash ?? null],
      ['Reauthorization superseded notebook hash',
        tr.kaggleLaunchReauthorization?.supersededNotebookSha256 ?? null],
      ['Staged install repair dependency set changed',
        tr.kaggleLaunchReauthorization?.stagedInstallRepair?.dependencySetChanged ?? null],
      ['Staged install repair declared specs unchanged',
        tr.kaggleLaunchReauthorization?.stagedInstallRepair?.declaredSpecsUnchanged ?? null],
      ['Launch attempts recorded',
        (tr.kaggleLaunchReauthorization ?? tr.kaggleLaunchAuthorization)?.launchAttemptHistory?.length ?? 0],
      ['Launch attempt 1 external status',
        (tr.kaggleLaunchReauthorization ?? tr.kaggleLaunchAuthorization)?.launchAttemptHistory?.[0]?.externalStatus ?? null],
      ['Launch attempt 1 root cause',
        (tr.kaggleLaunchReauthorization ?? tr.kaggleLaunchAuthorization)?.launchAttemptHistory?.[0]?.rootCauseClass ?? null],
      ['Launch attempt 2 external status',
        tr.kaggleLaunchReauthorization?.launchAttemptHistory?.[1]?.externalStatus ?? null],
      ['Launch attempt 2 root cause',
        tr.kaggleLaunchReauthorization?.launchAttemptHistory?.[1]?.rootCauseClass ?? null],
